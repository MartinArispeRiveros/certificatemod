...
class InscriptionsControllerTest < ActionController::TestCase
  ...
  test "should create inscription" do
    assert_difference('Inscription.count') do
      post :create, inscription: { client_id: @inscription.client_id, event_id: @inscription.event_id, is_received: @inscription.is_received }
    end
  ...
  test "should update inscription" do
    patch :update, id: @inscription, inscription: { client_id: @inscription.client_id, event_id: @inscription.event_id, is_received: @inscription.is_received }
    assert_redirected_to inscription_path(assigns(:inscription))
  end
